...
public class ValidateCodeFilter extends OncePerRequestFilter  implements InitializingBean{
    ...
    public void afterPropertiesSet() throws ServletException {
        ...
        addUrlToMap(securityRootProperties.getCode().getImage().getUrl(), ValidateCodeTypeEnum.IMAGE);

        urlMap.put(SecurityConstant.DEFAULT_LOGIN_PROCESSING_URL_MOBILE, ValidateCodeTypeEnum.SMS);
        addUrlToMap(securityRootProperties.getCode().getSms().getUrl(), ValidateCodeTypeEnum.SMS);
    }
